    ...
    return (
        <div className="navbar lg:flex flex-wrap justify-between ">
            <div className="flex justify-between">
                <img src={lighthouse} className="h-16 m-6 lg:ml-12" onClick={() => {scroll.scrollToTop()}} />
                <button type="button" className="block lg:hidden py-0 my-0 mx-5" onClick={onClickBurger}>
